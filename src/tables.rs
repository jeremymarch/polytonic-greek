...
pub(crate) const GREEK_PRECOMPOSED: [[char; 32]; 14] = [
    ...
    /* capitals */
    /* alpha    */  ['\u{0391}','\u{0386}','\u{0000}','\u{1F08}','\u{1F09}','\u{1FBB}','\u{1F0C}','\u{1F0D}','\u{1FBA}','\u{1F0A}','\u{1F0B}','\u{0000}','\u{1F0E}','\u{1F0F}','\u{0000}','\u{1F88}','\u{1F89}','\u{0000}','\u{1F8C}','\u{1F8D}','\u{0000}','\u{1F8A}','\u{1F8B}','\u{0000}','\u{1F8E}','\u{1F8F}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{1FB9}','\u{1FB8}'],
