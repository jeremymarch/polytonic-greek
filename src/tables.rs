...
pub(crate) const GREEK_PRECOMPOSED: [[char; 32]; 14] = [
    ...
    /* eta      */  ['\u{03B7}','\u{03AE}','\u{0000}','\u{1F20}','\u{1F21}','\u{1F75}','\u{1F24}','\u{1F25}','\u{1F74}','\u{1F22}','\u{1F23}','\u{1FC6}','\u{1F26}','\u{1F27}','\u{1FC3}','\u{1F90}','\u{1F91}','\u{1FC4}','\u{1F94}','\u{1F95}','\u{1FC2}','\u{1F92}','\u{1F93}','\u{1FC7}','\u{1F96}','\u{1F97}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{1FD0}'],
    /* iota     */  ['\u{03B9}','\u{03AF}','\u{0390}','\u{1F30}','\u{1F31}','\u{1F77}','\u{1F34}','\u{1F35}','\u{1F76}','\u{1F32}','\u{1F33}','\u{1FD6}','\u{1F36}','\u{1F37}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{03CA}','\u{1FD3}','\u{1FD2}','\u{1FD7}','\u{1FD1}','\u{0000}'],
    ...
    /* omega    */  ['\u{03C9}','\u{03CE}','\u{0000}','\u{1F60}','\u{1F61}','\u{1F7D}','\u{1F64}','\u{1F65}','\u{1F7C}','\u{1F62}','\u{1F63}','\u{1FF6}','\u{1F66}','\u{1F67}','\u{1FF3}','\u{1FA0}','\u{1FA1}','\u{1FF4}','\u{1FA4}','\u{1FA5}','\u{1FF2}','\u{1FA2}','\u{1FA3}','\u{1FF7}','\u{1FA6}','\u{1FA7}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}'],
    /* capitals */
