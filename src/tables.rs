...
pub(crate) const GREEK_PRECOMPOSED: [[char; 32]; 14] = [
    ...
    /* omega    */  ['\u{03C9}','\u{03CE}','\u{0000}','\u{1F60}','\u{1F61}','\u{1F7D}','\u{1F64}','\u{1F65}','\u{1F7C}','\u{1F62}','\u{1F63}','\u{1FF6}','\u{1F66}','\u{1F67}','\u{1FF3}','\u{1FA0}','\u{1FA1}','\u{1FF7}','\u{1FA4}','\u{1FA5}','\u{1FF2}','\u{1FA2}','\u{1FA3}','\u{1FA7}','\u{1FA6}','\u{1FA7}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}','\u{0000}'],
    /* capitals */
